...
## Example method
- example_add_user_by_transaction
- example_delete_by_id
- example_update_username_by_id
- example_find_one_by_id
- example_fetch_all
- example_fetch_all_by_dynamic_parameter_req
...
## more example code please see [main.rs](src/main.rs)